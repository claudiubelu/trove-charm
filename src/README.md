...
CONF_FILE_URL="https://raw.githubusercontent.com/openstack/trove/stable/zed/trove/templates/mysql/validation-rules.json"
juju run-action --wait trove/leader db-load-datastore-config-params \
